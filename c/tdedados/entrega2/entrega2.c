...
void OrdenarPorPrioridade(struct fila* f) {
    ...
    // Converter fila para array para facilitar ordenação
    ...
    // Ordenar array por prioridade (bubble sort simples)
